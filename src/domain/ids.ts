...
export type CatalystId     = string & { readonly [brand]: 'CatalystId' }
export type PreEventBriefId = string & { readonly [brand]: 'PreEventBriefId' }
export type PostEventReviewId = string & { readonly [brand]: 'PostEventReviewId' }
